...
//           <button className="px-2 py-1 bg-red-500 text-white rounded" onClick={() => dispatch(removeFromCart({ id: product.id }))}>-</button>
//           <span className="px-2">{quantity}</span>
//           <button className="px-2 py-1 bg-green-500 text-white rounded" onClick={() => dispatch(addToCart({ id: product.id }))}>+</button>
//         </div>
//         <span className="text-sm font-semibold">Total: ${quantity * product.price}</span>
//       </div>
//     </div>
//   )
// }
